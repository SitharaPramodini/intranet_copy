    ...
    return (
        ...
        <div class="w-full relative pt-4 px-6 bg-white border border-gray-200 rounded-lg shadow-sm gridwidth">
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-xl font-normal leading-none text-[#ff6000] ">Documents</h5>
                ...
                <ul role="list" class="divide-y divide-gray-200 ">
                    <li class="py-3 sm:py-4">
                        <div class="flex items-center transition-all duration-300 ease-in-out group">
                            <div class="shrink-0">
                                <IoDocumentAttach class="w-7 h-7 text-[#ff6000] transition-transform duration-300 ease-[cubic-bezier(0.4, 0, 0.2, 1)] group-hover:rotate-[-15deg] group-hover:scale-125" />
                            </div>
